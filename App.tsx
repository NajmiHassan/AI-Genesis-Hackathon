...
export default function App(): React.ReactElement {
  ...
  return (
    <div className="min-h-screen bg-slate-100 font-sans text-slate-800" style={{ fontFamily: "'Inter', sans-serif" }}>
       {/* Hero Section */}
       <div className="relative h-screen flex flex-col items-center justify-center text-center bg-gradient-to-br from-violet-200 via-white to-cyan-100 overflow-hidden px-4">
          <div className="absolute top-0 left-0 -ml-40 -mt-40 w-96 h-96 bg-violet-300 rounded-full opacity-30 animate-blob"></div>
          <div className="absolute bottom-0 right-0 -mr-40 -mb-40 w-96 h-96 bg-cyan-200 rounded-full opacity-30 animate-blob animation-delay-4000"></div>
          ...
          <div className="relative z-10">
            ...
            <p className="max-w-2xl mx-auto mt-6 text-lg text-slate-600">
              Stop typing out receipts. Let AI scan, structure, and save your expenses directly to Notion in seconds.
            </p>
            <div className="mt-8">
              <button
                onClick={handleScrollToApp}
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-violet-600 text-white font-semibold rounded-lg shadow-lg hover:bg-violet-700 disabled:bg-slate-400 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500 transform hover:scale-105"
              >
        ...
        <div className="bg-white p-6 md:p-10 rounded-2xl shadow-2xl shadow-slate-200/80">
          <header className="text-center mb-10">
            ...
            <p className="text-slate-600 mt-2">
              Follow these simple steps to digitize your receipts.
            </p>
          </header>
          ...
          <div className="space-y-8">
            ...
            <div className="text-center pt-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-violet-600 text-white font-semibold rounded-lg shadow-lg hover:bg-violet-700 disabled:bg-slate-400 disabled:cursor-not-allowed transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500"
              >
                {isProcessing ? (
                  <>
